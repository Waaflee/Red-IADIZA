...
module.exports = reloadCSS;
        ...
        module.hot.accept(reloadCSS);
      module.exports = {};
},{"./../../node_modules/animate.css/animate.css":9,"_css_loader":11}],14:[function(require,module,exports) {
...
module.exports="/avatar.dddb0e5e.png";
...
var avatar_md_1 = __importDefault(require("../assets/markdown/avatar.md"));
var avatar_png_1 = __importDefault(require("../assets/images/avatars/avatar.png"));
...
var users = {
    'avatar': {
        'description': marked_1["default"](avatar_md_1["default"]),
        'photoUrl': avatar_png_1["default"]
    }
};
exports["default"] = users;
},{"../assets/markdown/avatar.md":14,"../assets/images/avatars/avatar.png":15,"marked":16}],10:[function(require,module,exports) {
'use strict';
...
var Card = /** @class */function () {
    function Card(name) {
        this.description = users_1["default"][name].description;
        this.photoUrl = users_1["default"][name].photoUrl;
    }
...
},{"./users":12}],8:[function(require,module,exports) {
"use strict";
...
exports["default"] = function () {
    window.onload = function () {
        var nombres = ['avatar', 'avatar', 'avatar', 'avatar', 'avatar', 'avatar'];
        var investigadores = nombres.map(function (n) {
            return new cards_1["default"](n);
        });
        var container = document.getElementsByClassName('has-cards')[0];
        investigadores.map(function (n) {
            container.innerHTML += n.render();
        });
    };
};
},{"./cards":10}],5:[function(require,module,exports) {
"use strict";
...
var main_1 = __importDefault(require("./js/main"));
main_1["default"]();
},{"animate.css":9,"./css/main.scss":7,"./js/main":8}],36:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.689dc907.map